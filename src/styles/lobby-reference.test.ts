...
describe('arena lobby composition', () => {
  ...
  it('animates the primary call to action with always-on motion', () => {
    ...
    // Sem kill-switch de reduced motion: o pulse do CTA roda sempre.
    expect(lobbyStyles).not.toMatch(/prefers-reduced-motion: reduce\)/);
  });
